...
int main(){
    ...
    int Please_Stop_Changing_The_Conditions_For_This_Question_TT_TT[] = {45,36,24,12,18,60,80,11,67,79,69,11,65,14,22};
...
//=================== 입력 처리 ===========================
    ...
    totaldata = sizeof Please_Stop_Changing_The_Conditions_For_This_Question_TT_TT / sizeof Please_Stop_Changing_The_Conditions_For_This_Question_TT_TT[0];
    maxroll = totaldata/3;
